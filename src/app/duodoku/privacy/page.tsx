        ...
        <div className="min-h-screen bg-white flex items-center justify-center p-4 pt-20">
            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="mb-8">
                    ...
                    />
                    <h1 className="text-6xl font-bold text-gray-900 mb-4">DUODOKU</h1>
                ...
                <div className="bg-gray-50 rounded-2xl p-8 mb-8 border border-gray-200 text-left">
                    ...
                    <ul className="text-gray-700 space-y-2 mb-6">
                        <li>• Les données de jeu (scores, statistiques, préférences) sont conservées tant que l&apos;application est installée sur votre appareil et que votre compte est actif.</li>
