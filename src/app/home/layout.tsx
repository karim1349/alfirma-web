...
export const metadata: Metadata = {
  ...
  description:
    "Al Firma vous accompagne dans le développement de vos applications mobiles et web. Solutions personnalisées, design UX/UI, et déploiement. Applications mobiles iOS / Android sur mesure.",
  keywords:
    "développement mobile, application web, React Native, Django, UX/UI design, agence développement, développement sur mesure, applications iOS, applications Android",
  openGraph: {
